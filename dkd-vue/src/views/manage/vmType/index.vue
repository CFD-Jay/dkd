<template>
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="型号名称" prop="name">
        ...
        <el-form-item label="货道数" prop="vmRow" >
          <el-input-number :min="1" :max="10" :controls="false"  v-model="form.vmRow" style="width: 50px;"  />行&nbsp;
          <el-input-number :min="1" :max="10" :controls="false" v-model="form.vmCol"  style="width: 50px;" />列
        </el-form-item>
        <el-form-item label="设备容量" prop="channelMaxCapacity">
          <el-input-number :min="1" :max="10" :controls="false" v-model="form.channelMaxCapacity" placeholder="请输入设备容量" />
        </el-form-item>
