<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" prop="policyId" type="index" :width="80" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary"  @click="watchMessage(scope.row)" v-hasPermi="['manage:vm:list']">查看详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="策略方案" prop="discount">
          <el-input-number :min="1" :max="100" :precision="0" :controls="false" v-model="form.discount" placeholder="请输入策略方案" />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!--查看策略详情-->
    <el-dialog :title="title" v-model="watchMessageOpen" width="700px" append-to-body>
      <el-form>
        <el-form-item label="策略名称" prop="policyName">
          <el-input v-model="now_policyName" disabled />
        </el-form-item>
      </el-form>
      <span>包含设备</span><br><br>
      <el-table :data="vmList">
        <el-table-column label="序号" align="center" prop="vmId" type="index" :width="80" />
...
function watchMessage(row) {
  ...
  listVm({policyId: _policyId}).then(response => {
  ...
  now_policyName.value=row.policyName;
}
