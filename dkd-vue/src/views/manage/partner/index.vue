<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" width="90px" align="center" prop="id" type="index" />
      <el-table-column label="合作商名称" align="center" prop="partnerName" />
      <el-table-column label="账号" align="center" prop="account" width="200px" />
      ...
      <el-table-column label="联系人" align="center" prop="contactPerson"  width="200px" />
      <el-table-column label="联系电话" align="center" prop="contactPhone" width="200px" />
  
      
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="250">
        <template #default="scope">
          <el-button link type="primary" @click="resetPassword(scope.row)" v-hasPermi="['manage:partner:edit']">重置密码</el-button>
          <el-button link type="primary" @click="watchMessage(scope.row)" v-hasPermi="['manage:partner:query']">查看详情</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="partnerRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="账号" prop="account" v-if="addOrEdit">
          <el-input v-model="form.account" placeholder="请输入账号" />
        </el-form-item>
        <el-form-item label="密码" prop="password" v-if="addOrEdit" >
          <el-input type="password" v-model="form.password" placeholder="请输入密码" />
        </el-form-item>
        <el-form-item label="创建时间" prop="createTime" v-if="!addOrEdit" >
    ...
    <el-dialog :title="detailTitle" v-model="detailOpen" width="500px" append-to-body>
      <el-form :model="form" label-width="100px" disabled>
        ...
        <el-form-item label="分成比例">
          <el-input v-model="form.shareRatio" />
        </el-form-item>
      </el-form>
      <template #footer>
        <div class="dialog-footer">
...
{
  const _id = row.id;
  proxy.$modal.confirm('是否确认重置该合作商密码？').then(function() {
    return resetPwd(_id);
  }).then(() => {
