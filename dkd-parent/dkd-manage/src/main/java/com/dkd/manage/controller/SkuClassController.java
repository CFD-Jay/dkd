 ...
 */
@RestController
@RequestMapping("/manage/sku_class")
public class SkuClassController extends BaseController
{
     ...
     * 查询商品类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:list')")
    @GetMapping("/list")
     ...
     * 导出商品类型列表
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:export')")
     ...
     * 获取商品类型详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:query')")
     ...
     * 新增商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:add')")
     ...
     * 修改商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:edit')")
     ...
     * 删除商品类型
     */
    @PreAuthorize("@ss.hasPermi('manage:sku_class:remove')")
