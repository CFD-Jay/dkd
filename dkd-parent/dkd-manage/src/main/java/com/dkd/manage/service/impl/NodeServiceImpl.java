...
@Autowired
    ...
    public int insertNode(Node node)
    {
        ...
        node.setCreateBy((String)session.getAttribute("user"));
        node.setUpdateBy((String)session.getAttribute("user"));
    ...
    public List<NodeVo> selectNodeVoList(Node node) {
        System.out.println(nodeMapper.selectNodeVoList(node));
        return nodeMapper.selectNodeVoList(node);
    }

    @Override
    public List<Node> nodeListByRegionId(Long regionId) {
        System.out.println(regionId);
        return nodeMapper.nodeListByRegionId(regionId);
    }
}
